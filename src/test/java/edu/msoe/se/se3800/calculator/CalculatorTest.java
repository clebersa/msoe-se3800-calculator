...
public class CalculatorTest {
    ...
    /**
     * Tests pair of parenthesis not nestled.
     *
     * @author cleber
     */
    @Test
    ...
    /**
     * Tests invalid element between ')'s.
     *
     * @author cleber
     */
    @Test(expected = InvalidParameterException.class)
    ...
    /**
     * Tests solveEquation with null equation.
     *
     * @author cleber
     */
    @Test(expected = InvalidParameterException.class)
    ...
    /**
     * Tests solveEquation with empty equation.
     *
     * @author cleber
     */
    @Test(expected = InvalidParameterException.class)
    ...
    /**
     * Tests solveEquation with a equation filled with tab.
     *
     * @author cleber
     */
    @Test(expected = InvalidParameterException.class)
    ...
    /**
     * Tests solveEquation with a equation filled with tabs and spaces.
     *
     * @author cleber
     */
    @Test(expected = InvalidParameterException.class)
